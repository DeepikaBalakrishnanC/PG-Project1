...
Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et=(EditText) findViewById(R.id.editTextTextPersonName8);
        et1=(EditText) findViewById(R.id.editTextTextPersonName9);
        et2=(EditText) findViewById(R.id.editTextTextPersonName10);
        et3=(EditText) findViewById(R.id.editTextTextPersonName11);
        img=(ImageView) findViewById(R.id.imageView2);
        img.setOnClickListener(this);
        et4=(EditText) findViewById(R.id.editTextTextPersonName12);
        et5=(EditText)findViewById(R.id.editTextTextPersonName13);
...
showfilechooser(1);
            ...
            String place = et1.getText().toString();
            String district = et2.getText().toString();
